...
**Status:** Last checkpoint 2026-09-11 · Next: Day 3 - WACC module: cost of equity from Damodaran India ERP and beta (pages.stern.nyu.edu, now reachable), cost of debt from the filings, capital structure from the balance sheet already in data/GULFOILLUB/financials.csv
